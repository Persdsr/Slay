...
import com.slay.course.service.user.UserService;
...
public class UserController {
    ...
    @GetMapping("/{username}")
    public ResponseEntity<UserProfileDTO> getAuthorProfile(@AuthenticationPrincipal UserDetails userDetails,
    ...
    @GetMapping("/profile")
    public ResponseEntity<UserProfileSettingDTO> getSettingsData(@AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<List<TrainingCourseLiteDTO>> getMyPurchaseCourses(@AuthenticationPrincipal UserDetails userDetails) {
    ...
    @PreAuthorize("isAuthenticated()")
    @PostMapping("/follow")
    public ResponseEntity<HttpStatus> handleFollowToUser(@AuthenticationPrincipal UserDetails userDetails,
    ...
    public ResponseEntity<HttpStatus> handleUnFollowToUser(@AuthenticationPrincipal UserDetails userDetails,
