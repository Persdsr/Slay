...
import com.slay.course.service.complaint.ComplaintService;
...
public class ComplaintController {
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN', 'MODERATOR')")
    @GetMapping("/user")
    public ResponseEntity<List<ComplaintDTO>> getAllUserComplaintRequests(@RequestParam("username") String username) {
        return ResponseEntity.ok().body(complaintService.getAllUserComplaintsRequests(username));
    }
