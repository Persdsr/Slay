...
import com.slay.user.service.user.AuthService;

import com.slay.user.exception.EmailNotFoundException;

import com.slay.user.service.mail.EmailService;
...
public class AuthController {
    ...
    @GetMapping("/userinfo")
    public ResponseEntity<Map<String, Object>> getUserInfo(@AuthenticationPrincipal UserDetailsImpl userDetails) {
