...
import com.slay.user.dto.request.auth.SignInRequest;
import com.slay.user.dto.request.auth.SignUpRequest;
import com.slay.user.entity.user.PasswordResetToken;
import com.slay.user.entity.user.UserEntity;
import com.slay.user.exception.EmailAlreadyExistsException;
import com.slay.user.exception.UsernameAlreadyExistsException;

import com.slay.user.security.services.UserDetailsImpl;
import com.slay.user.repository.PasswordResetTokenRepository;
import com.slay.user.repository.UserRepo;
import com.slay.user.security.JwtUtils;
...
public class AuthService {
    ...
    public Map<String, Object> getUserInfo(@AuthenticationPrincipal UserDetailsImpl userDetails) {
