...
import com.slay.user.dto.response.user.BirthdayNotificationDTO;
...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, BirthdayNotificationDTO> birthdayProducerFactory() {
        ...
        configProps.put(JsonSerializer.TYPE_MAPPINGS, "birthdayNotificationDto:com.slay.user.dto.response.user.BirthdayNotificationDTO");
    ...
    public ProducerFactory<String, ForgotPasswordDTO> forgotPasswordProducerFactory() {
        ...
        configProps.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
        configProps.put(JsonSerializer.TYPE_MAPPINGS, "forgotPasswordDto:com.slay.user.dto.response.user.ForgotPasswordDTO");
        return new DefaultKafkaProducerFactory<>(configProps);
    }
